...
export class NotificationController {
    ...
    async getNotificationSetting(@Req() req) {
        const userId = req.user.id
        const settings = await this.notificationService.getNotificationSettingsByUserId(userId)
    ...
    async updateNotificationSetting(@Req() req , @Body('settings') settings : NotificationSettingResponseDTO) {
        const userId = req.user.id
