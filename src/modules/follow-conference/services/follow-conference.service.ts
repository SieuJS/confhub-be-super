...
export class FollowConferenceService {
    ...
    async notifyFollowersAboutConferenceUpdate(conferenceId: string) {
        try {
            ...
            const latestOrg = conference.organizations[conference.organizations.length - 1];
