...
class ConferenceData {
  @ApiProperty({
    example: 'AAAI Conference on Human Computation and Crowdsourcing',
  })
  name: string;
  ...
  @ApiProperty({
    example:
      'Human Computation, Crowdsourcing, Artificial Intelligence, Human-Computer Interaction, Social Computing, Artificial Intelligence Economics, Computational Social Science, Digital Humanities, Policy, Ethics',
  })
  topics: string;
